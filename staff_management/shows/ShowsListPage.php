    ...
    <div class="wrapper">
        ...
        <div style="margin-bottom: 50px;">
            <div class="form-inline">
                <h2 style="margin-top: 20px;">Shows List</h2>
                <button id="addShowsBtn" class="btn btn-primary" style="margin-left: 77%;margin-top: 20px;" onclick="location.href='AddNewShowPage.php'">Add New Shows</button>
            </div>
