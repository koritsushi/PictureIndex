...
$sqlSearch = "SELECT * FROM shows WHERE status = '0' AND showsName LIKE '%" . $_POST["search"] . "%' ORDER BY showsID desc";
$sqlSearchID = "SELECT * FROM shows WHERE status = '0' AND showsID LIKE '%" . $_POST["search"] . "%' ORDER BY showsID desc";
